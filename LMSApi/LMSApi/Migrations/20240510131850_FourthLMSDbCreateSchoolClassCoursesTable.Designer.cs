...
namespace LMSApi.Migrations
{
    ...
    [Migration("20240510131850_FourthLMSDbCreateSchoolClassCoursesTable")]
    partial class FourthLMSDbCreateSchoolClassCoursesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMSBase.Models.Domain.CoachSchoolClass", b =>
                {
                    b.Property<int>("CoachSchoolClassId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CoachSchoolClassId"));
                    ...
                    b.HasKey("CoachSchoolClassId");

                    b.HasIndex("CoachId");

                    b.HasIndex("SchoolClassId");

                    b.ToTable("CoachSchoolClasses");
                });
            ...
            modelBuilder.Entity("LMSBase.Models.Domain.SchoolClassCourse", b =>
                {
                    b.Property<int>("SchoolClassCourseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SchoolClassCourseId"));
            ...
            modelBuilder.Entity("LMSBase.Models.Domain.StudentCodelab", b =>
                {
                    ...
                    b.ToTable("StudentCodeLabs");
                });

            modelBuilder.Entity("LMSBase.Models.Domain.CoachSchoolClass", b =>
                {
                    b.HasOne("LMSBase.Models.Domain.Coach", "Coach")
                        .WithMany("CoachSchoolClasses")
            ...
            modelBuilder.Entity("LMSBase.Models.Domain.Coach", b =>
                {
                    b.Navigation("CoachSchoolClasses");
                });
